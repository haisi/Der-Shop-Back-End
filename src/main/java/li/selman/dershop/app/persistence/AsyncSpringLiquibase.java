 ...
 * DataSource if necessary. <p> By default, this asynchronous version only works when using the "dev" profile.
 * <p> The standard
...
public class AsyncSpringLiquibase extends DataSourceClosingSpringLiquibase {
    ...
    public void afterPropertiesSet() throws LiquibaseException {
        if (!env.acceptsProfiles(Profiles.of(ProfileConstants.NO_LIQUIBASE))) {
            if (env.acceptsProfiles(Profiles.of(ProfileConstants.DEV + "|" + ProfileConstants.HEROKU))) {
